...
Point(newp) = {1.45+0.5+0.0006 , -0.075-0.0006, 0, tf}; /*33*/
...
Point(newp) = {1.375-0.3-0.0003 , 0.0+0.05+0.0006, 0, tf}; /*31*/
...
Point(newp) = {1.1625+0.5-0.001 , -0.4625+0.001-0.04, 0, tf}; /*29*/
