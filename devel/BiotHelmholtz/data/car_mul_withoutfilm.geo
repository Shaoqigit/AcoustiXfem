...
Point(newp) = {0.725+0.5 , -0.3375, 0, ta}; /*27*/
Point(newp) = {0.9085+0.5 , -0.3554, 0, ta}; /*28*/
Point(newp) = {1.1625+0.5 , -0.4625, 0, ta}; /*29*/
Point(newp) = {1.2029+0.5 , -0.205, 0, ta}; /*30*/
Point(newp) = {1.375+0.5 , 0.0, 0, ta}; /*31*/
Point(newp) = {1.45 , -0.0125, 0, ta};
Point(newp) = {1.45+0.5 , -0.075, 0, ta}; /*33*/
Point(newp) = {1.275+0.5 , -0.475, 0, ta}; /*34*/
Point(newp) = {1.2+0.5 , -0.5625, 0, ta}; /*38*/
Point(newp) = {1.0875 , -0.5375, 0, ta};
Point(newp) = {0.7625+0.5 , -0.5375, 0, ta}; /*37*/
Point(newp) = {0.675+0.5 , -0.4, 0, ta}; /*38*/
...
Point(newp) = {1.4125+0.5 , -0.00625, 0, ta}; /*315*/
Point(newp) = {1.45+0.5 , -0.04375, 0, ta}; /*316*/

Point(newp) = {0.725-0.3 , -0.3375+0.05, 0, ta}; /*27*/
Point(newp) = {0.9085-0.3 , -0.3554+0.05, 0, ta}; /*28*/
Point(newp) = {1.1625-0.3 , -0.4625+0.05, 0, ta}; /*29*/
Point(newp) = {1.2029-0.3 , -0.205+0.05, 0, ta}; /*30*/
Point(newp) = {1.375-0.3 , 0.0+0.05, 0, ta}; /*31*/
Point(newp) = {1.45-0.3 , -0.075+0.05, 0, ta}; /*33*/
Point(newp) = {1.275-0.3 , -0.475+0.05, 0, ta}; /*34*/
Point(newp) = {1.2-0.3 , -0.5625+0.05, 0, ta}; /*38*/
Point(newp) = {0.7625-0.3 , -0.5375+0.05, 0, ta}; /*37*/
Point(newp) = {0.675-0.3 , -0.4+0.05, 0, ta}; /*38*/
Point(newp) = {1.4125-0.3 , -0.00625+0.05, 0, ta}; /*315*/
Point(newp) = {1.45-0.3 , -0.04375+0.05, 0, ta}; /*316*/

Point(newp) = {0.725+0.5-0.0003 , -0.3375+0.0007, 0, ta}; /*27*/
Point(newp) = {0.9085+0.5 , -0.3554+0.0007, 0, ta}; /*28*/
Point(newp) = {1.1625+0.5-0.0005 , -0.4625+0.001, 0, ta}; /*29*/
Point(newp) = {1.2029+0.5-0.0006 , -0.205+0.0004, 0, ta}; /*30*/
Point(newp) = {1.375+0.5-0.0003 , 0.0+0.0006, 0, ta}; /*31*/
Point(newp) = {1.45+0.5+0.0006 , -0.075, 0, ta}; /*33*/
Point(newp) = {1.275-0.3 , -0.475, 0, ta}; /*34*/
Point(newp) = {1.2+0.5+0.0005 , -0.5625-0.0007, 0, ta}; /*35*/
Point(newp) = {0.7625+0.5-0.0005 , -0.5375-0.0007, 0, ta}; /*37*/
Point(newp) = {0.675+0.5-0.001 , -0.4, 0, ta}; /*38*/
Point(newp) = {1.4125+0.5+0.0002 , -0.00625+0.0005, 0, ta}; /*315*/
Point(newp) = {1.45+0.5+0.0006 , -0.04375+0.0003, 0, ta}; /*316*/


Point(newp) = {0.725-0.3-0.0003 , -0.3375+0.05+0.0007, 0, ta}; /*27*/
Point(newp) = {0.9085-0.3 , -0.3554+0.05+0.0007, 0, ta}; /*28*/
Point(newp) = {1.1625-0.3-0.0005 , -0.4625+0.05+0.001, 0, ta}; /*29*/
Point(newp) = {1.2029-0.3-0.0006 , -0.205+0.05+0.0004, 0, ta}; /*101*/
Point(newp) = {1.375-0.3-0.0003 , 0.0+0.05+0.0006, 0, 0.002}; /*31*/
Point(newp) = {1.45-0.3+0.0006 , -0.075+0.05, 0, ta}; /*33*/
Point(newp) = {1.275-0.3 , -0.475+0.05, 0, ta}; /*34*/
Point(newp) = {1.2-0.3+0.0005 , -0.5625+0.05-0.001, 0, ta}; /*38*/
Point(newp) = {0.7625-0.3-0.0005 , -0.5375+0.05-0.0007, 0, ta}; /*37*/
Point(newp) = {0.675-0.3-0.001 , -0.4+0.05, 0, ta}; /*107*/
Point(newp) = {1.4125-0.3+0.0002 , -0.00625+0.05+0.0005, 0, ta}; /*108*/
Point(newp) = {1.45-0.3+0.0006 , -0.04375+0.05+0.0003, 0, ta}; /*316*/
...
Point(newp) = {1.375+0.5-0.001 , 0.0+0.001, 0, ta}; /*31*/
Point(newp) = {1.45+0.5+0.001 , -0.075, 0, ta}; /*33*/
Point(newp) = {1.275-0.3 , -0.475, 0, ta}; /*34*/
Point(newp) = {1.2+0.5+0.001 , -0.5625-0.001, 0, ta}; /*35*/
Point(newp) = {0.7625+0.5-0.001 , -0.5375-0.001, 0, ta}; /*37*/
Point(newp) = {0.675+0.5-0.001 , -0.4, 0, ta}; /*38*/
Point(newp) = {1.4125+0.5 , -0.00625-0.05, 0, ta}; /*315*/
Point(newp) = {1.45+0.5+0.001 , -0.04375, 0, ta}; /*316*/

Point(newp) = {1.275+0.5+0.0008 , -0.475-0.0006, 0, ta}; /*34*/
Point(newp) = {1.275-0.3+0.0008 , -0.475+0.05-0.0006, 0, ta}; /*34*/
...
//+
Point(140) = {0.837, -0.37, 0, 0.05};
//+
Point(141) = {1.636, -0.42, 0, 0.05};
//+
Point{140, 141} In Surface{1};
